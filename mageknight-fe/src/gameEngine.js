...
export function createGame(seed = 20260901, options = {}) {
  ...
  const state = {
    ...
    points: freshPoints(), mana: [], sourceTaken: false, combat: null, pendingRewards:[], bonuses:freshBonuses(),pendingCardBoost:null,pendingBorrowedEffect:null,pendingRepeatedEffect:null,pendingSpellEffect:null,pendingManaMeltdown:null,pendingMeditation:null, log: [], error: null,
...
const EFFECT_PHASES = {
  ...
  influence:['action'], heal:['action'], draw:['action'], mana:['action'], command:['action'], fame:['action'], unitReady:['action'], restoration:['action'], manaMeltdown:['action'], energyFlow:['action'], meditation:['action'], callToArms:['action','combat-ranged','combat-block','combat-attack'],
  ...
  influenceScaling:['action'], spaceBending:['action'], timeBending:['action'], manaClaim:['action'],
