...
const migrateState=state=>{
  ...
  state.bonuses={...freshBonuses(),...(state.bonuses||{})};state.pendingCardBoost=state.pendingCardBoost||null;state.pendingBorrowedEffect=state.pendingBorrowedEffect||null;state.pendingRepeatedEffect=state.pendingRepeatedEffect||null;state.pendingSpellEffect=state.pendingSpellEffect||null;state.pendingManaMeltdown=state.pendingManaMeltdown||null;
...
export function createGame(seed = 20260901, options = {}) {
  ...
  const state = {
    ...
    points: freshPoints(), mana: [], sourceTaken: false, combat: null, pendingRewards:[], bonuses:freshBonuses(),pendingCardBoost:null,pendingBorrowedEffect:null,pendingRepeatedEffect:null,pendingSpellEffect:null,pendingManaMeltdown:null, log: [], error: null,
...
const EFFECT_PHASES = {
  ...
  influence:['action'], heal:['action'], draw:['action'], mana:['action'], command:['action'], fame:['action'], unitReady:['action'], restoration:['action'], manaMeltdown:['action'], energyFlow:['action'],
