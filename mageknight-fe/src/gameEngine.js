...
const EFFECT_PHASES = {
  ...
  influence:['action'], heal:['action'], draw:['action'], mana:['action'], command:['action'], fame:['action'], unitReady:['action'], restoration:['action'], manaMeltdown:['action'], manaClaim:['action'], mindRead:['action'], cure:['action'], charm:['action'], disease:['combat-block','combat-attack'], possessEnemy:['combat-ranged','combat-block'], energyFlow:['action'], meditation:['action'], callToArms:['action','combat-ranged','combat-block','combat-attack'],
