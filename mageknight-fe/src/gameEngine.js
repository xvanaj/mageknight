...
function spendMana(state, color) {
  ...
  if (state.player.crystals[color] > 0) { if(!state.bonuses.crystalMastery)state.player.crystals[color]--; return true; }
  return false;
}
