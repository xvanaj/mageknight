...
const EFFECT_PHASES = {
  ...
  armorBreak:['combat-ranged','combat-block','combat-attack'], armorChange:['combat-ranged','combat-block','combat-attack'], allArmorChange:['combat-ranged','combat-block','combat-attack'], exposeTarget:['combat-ranged'], exposeAll:['combat-ranged'], enemyControl:['combat-ranged','combat-block'], defeatTarget:['combat-ranged','combat-block','combat-attack'], manaBolt:['combat-ranged','combat-attack'],
};
