...
export const EXTENDED_ARTIFACTS = [
  ...
  {id:'diamond-ring',name:'Diamond Ring',color:'white',type:'artifact',basic:{manaRing:{color:'white',mode:'basic'}},strong:{manaRing:{color:'white',mode:'strong'}}},
  ...
  {id:'emerald-ring',name:'Emerald Ring',color:'green',type:'artifact',basic:{manaRing:{color:'green',mode:'basic'}},strong:{manaRing:{color:'green',mode:'strong'}}},
];

// Local coordinates follow the fixed orientation printed on every physical tile:
// center, NE, E, SE, SW, W, NW.
export const STARTING_TILES = {
  A:[[0,0,'plains','portal'],[0,-1,'plains'],[1,-1,'forest'],[-1,0,'lake'],[1,0,'plains'],[-1,1,'lake'],[0,1,'mountain']],
  B:[[0,0,'plains','portal'],[1,-1,'forest'],[1,0,'plains'],[0,1,'plains'],[-1,1,'mountain'],[-1,0,'lake'],[0,-1,'plains']],
};

export const MAP_TILES = [
  {id:'countryside-a',core:false,hexes:[[0,0,'forest','glade'],[1,-1,'lake'],[1,0,'plains','village'],[0,1,'plains'],[-1,1,'plains'],[-1,0,'forest'],[0,-1,'forest','rampaging','prowlers']]},
  {id:'countryside-b',core:false,hexes:[[0,0,'hills'],[1,-1,'forest','glade'],[1,0,'plains','village'],[0,1,'plains'],[-1,1,'hills','mine',null,null,'green'],[-1,0,'plains'],[0,-1,'hills','rampaging','prowlers']]},
  {id:'countryside-c',core:false,hexes:[[0,0,'forest'],[1,-1,'hills','keep','guards'],[1,0,'hills'],[0,1,'hills','mine',null,null,'white'],[-1,1,'plains','village'],[-1,0,'plains'],[0,-1,'plains']]},
  {id:'countryside-d',core:false,hexes:[[0,0,'desert','mage-tower','mage'],[1,-1,'desert'],[1,0,'mountain'],[0,1,'plains','village'],[-1,1,'plains'],[-1,0,'hills','rampaging','prowlers'],[0,-1,'desert']]},
  {id:'countryside-e',core:false,hexes:[[0,0,'lake'],[1,-1,'plains','monastery'],[1,0,'plains','rampaging','prowlers'],[0,1,'hills','mine',null,null,'blue'],[-1,1,'forest'],[-1,0,'forest','glade'],[0,-1,'forest']]},
  {id:'countryside-f',core:false,hexes:[[0,0,'hills','mine',null,null,'red'],[1,-1,'forest'],[1,0,'plains'],[0,1,'forest','rampaging','prowlers'],[-1,1,'hills'],[-1,0,'hills','monster-den','den'],[0,-1,'mountain']]},
  {id:'countryside-g',core:false,hexes:[[0,0,'swamp'],[1,-1,'forest','rampaging','prowlers'],[1,0,'forest','glade'],[0,1,'plains','dungeon','golem'],[-1,1,'plains'],[-1,0,'plains','monastery'],[0,-1,'lake']]},
  {id:'countryside-h',core:false,hexes:[[0,0,'swamp','rampaging','prowlers'],[1,-1,'forest','ruins'],[1,0,'plains'],[0,1,'swamp','village'],[-1,1,'swamp'],[-1,0,'forest'],[0,-1,'forest','glade']]},
  {id:'countryside-i',core:false,hexes:[[0,0,'mountain'],[1,-1,'mountain'],[1,0,'wasteland','keep','guards'],[0,1,'plains'],[-1,1,'wasteland','mage-tower','mage'],[-1,0,'plains'],[0,-1,'wasteland','dungeon','golem']]},
  {id:'countryside-j',core:false,hexes:[[0,0,'mountain'],[1,-1,'forest'],[1,0,'plains'],[0,1,'hills','ruins'],[-1,1,'hills','keep','guards'],[-1,0,'hills'],[0,-1,'hills','monster-den','den']]},
  {id:'countryside-k',core:false,hexes:[[0,0,'plains','mage-tower','mage'],[1,-1,'lake'],[1,0,'lake'],[0,1,'hills','rampaging','prowlers'],[-1,1,'lake'],[-1,0,'plains','ruins'],[0,-1,'hills']]},
  {id:'core-a',core:true,cityCore:true,hexes:[[0,0,'wasteland','city','city','red'],[1,-1,'hills','mine',null,null,'red'],[1,0,'desert'],[0,1,'desert','draconum','dragon'],[-1,1,'wasteland'],[-1,0,'wasteland','draconum','dragon'],[0,-1,'desert','ruins']]},
  {id:'core-b',core:true,cityCore:true,hexes:[[0,0,'plains','city','city','blue'],[1,-1,'plains','monastery'],[1,0,'lake'],[0,1,'lake'],[-1,1,'hills'],[-1,0,'mountain','draconum','dragon'],[0,-1,'forest']]},
  {id:'core-c',core:true,cityCore:false,hexes:[[0,0,'desert','monastery'],[1,-1,'desert','tomb','tomb'],[1,0,'desert'],[0,1,'desert'],[-1,1,'hills'],[-1,0,'hills','spawning-grounds','spawn'],[0,-1,'mountain']]},
  {id:'core-d',core:true,cityCore:false,hexes:[[0,0,'lake'],[1,-1,'wasteland','ruins'],[1,0,'hills','mine',null,null,'green'],[0,1,'swamp','draconum','dragon'],[-1,1,'swamp','mage-tower','mage'],[-1,0,'forest'],[0,-1,'lake']]},
  {id:'core-e',core:true,cityCore:true,hexes:[[0,0,'plains','city','city','white'],[1,-1,'plains'],[1,0,'forest'],[0,1,'lake','draconum','dragon'],[-1,1,'lake'],[-1,0,'wasteland','keep','guards'],[0,-1,'wasteland','spawning-grounds','spawn']]},
  {id:'core-f',core:true,cityCore:true,hexes:[[0,0,'plains','city','city','green'],[1,-1,'swamp','village'],[1,0,'swamp','rampaging','prowlers'],[0,1,'swamp'],[-1,1,'forest','rampaging','prowlers'],[-1,0,'lake'],[0,-1,'forest','glade']]},
  {id:'core-g',core:true,cityCore:false,hexes:[[0,0,'wasteland'],[1,-1,'wasteland','ruins'],[1,0,'hills','mage-tower','mage'],[0,1,'wasteland'],[-1,1,'hills','mine',null,null,'white'],[-1,0,'wasteland','tomb','tomb'],[0,-1,'mountain']]},
  {id:'core-h',core:true,cityCore:false,hexes:[[0,0,'mountain','draconum','dragon'],[1,-1,'hills'],[1,0,'hills','keep','guards'],[0,1,'wasteland'],[-1,1,'wasteland','ruins'],[-1,0,'wasteland'],[0,-1,'wasteland','mine',null,null,'blue']]},
];
