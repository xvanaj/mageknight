...
export const MAP_TILES = [
  ...
  {id:'countryside-d',core:false,hexes:[[3,0,'plains','village'],[4,0,'forest','glade'],[4,-1,'hills','keep','guards'],[5,-1,'desert','ruins','golem'],[5,-2,'wasteland','rampaging','prowlers'],[4,-2,'lake']]},
  {id:'countryside-e',core:false,hexes:[[6,-2,'plains'],[6,-3,'forest','mine'],[5,-3,'hills','keep','guards'],[4,-3,'swamp'],[3,-4,'desert','ruins','golem'],[2,-4,'lake']]},
  {id:'countryside-f',core:false,hexes:[[7,-2,'plains','village'],[7,-3,'forest','glade'],[7,-4,'hills','mage-tower','mage'],[6,-4,'wasteland','rampaging','diggers'],[5,-4,'desert'],[4,-4,'lake']]},
  {id:'countryside-g',core:false,hexes:[[8,-2,'plains'],[8,-3,'forest','monastery'],[8,-4,'hills','mine'],[8,-5,'swamp','monster-den','den'],[7,-5,'wasteland'],[6,-5,'mountain']]},
  {id:'countryside-h',core:false,hexes:[[9,-2,'plains','village'],[9,-3,'forest'],[9,-4,'hills','rampaging','prowlers'],[9,-5,'desert','ruins','golem'],[9,-6,'wasteland'],[8,-6,'lake']]},
  {id:'countryside-i',core:false,hexes:[[10,-2,'plains'],[10,-3,'forest','glade'],[10,-4,'hills','keep','guards'],[10,-5,'swamp'],[10,-6,'desert','draconum','dragon'],[10,-7,'mountain']]},
  {id:'countryside-j',core:false,hexes:[[11,-2,'plains','village'],[11,-3,'forest','mine'],[11,-4,'hills'],[11,-5,'wasteland','mage-tower','mage'],[11,-6,'desert','rampaging','diggers'],[11,-7,'lake']]},
  {id:'countryside-k',core:false,hexes:[[12,-2,'plains'],[12,-3,'forest','monastery'],[12,-4,'hills','glade'],[12,-5,'swamp','dungeon','golem'],[12,-6,'wasteland'],[12,-7,'mountain']]},
  {id:'core-a',core:true,cityCore:true,hexes:[[3,-1,'plains'],[3,-2,'wasteland','city','city','red'],[3,-3,'desert'],[2,-3,'forest','mine'],[-3,0,'plains'],[-3,1,'hills','tomb','tomb']]},
  {id:'core-b',core:true,cityCore:true,hexes:[[-3,2,'forest','monster-den','den'],[-3,3,'swamp','spawning-grounds','spawn'],[-2,3,'plains','city','city','blue'],[-1,3,'hills','keep','guards'],[0,3,'forest','mage-tower','mage'],[1,3,'desert','draconum','highDragon']]},
  {id:'core-c',core:true,cityCore:false,hexes:[[1,-4,'forest','monster-den','den'],[0,-4,'desert','draconum','dragon'],[-1,-3,'hills','keep','guards'],[-2,-2,'plains','village'],[-3,-1,'wasteland','dungeon','golem'],[-4,0,'forest','mage-tower','mage']]},
  {id:'core-d',core:true,cityCore:false,hexes:[[-4,1,'plains','monastery'],[-4,2,'swamp','ruins','golem'],[-4,3,'forest','glade'],[-4,4,'desert','draconum','iceDragon'],[-3,4,'hills','keep','guards'],[-2,4,'plains','mine']]},
  {id:'core-e',core:true,cityCore:true,hexes:[[7,-6,'forest'],[8,-7,'hills','city','city','white'],[9,-7,'desert','draconum','highDragon'],[9,-8,'wasteland','tomb','tomb'],[8,-8,'plains','mine'],[7,-7,'forest','keep','guards']]},
  {id:'core-f',core:true,cityCore:true,hexes:[[6,-6,'plains'],[6,-7,'forest','city','city','green'],[6,-8,'hills','spawning-grounds','spawn'],[7,-8,'desert','draconum','highDragon'],[7,-9,'wasteland','mage-tower','mage'],[6,-9,'swamp','ruins','golem']]},
  {id:'core-g',core:true,cityCore:false,hexes:[[-5,0,'forest','monster-den','den'],[-5,1,'hills','keep','guards'],[-5,2,'desert','draconum','iceDragon'],[-5,3,'wasteland','dungeon','golem'],[-5,4,'plains','monastery'],[-4,5,'forest','mine']]},
  {id:'core-h',core:true,cityCore:false,hexes:[[-6,0,'plains','village'],[-6,1,'forest','glade'],[-6,2,'hills','tomb','tomb'],[-6,3,'swamp','spawning-grounds','spawn'],[-6,4,'desert','draconum','highDragon'],[-6,5,'wasteland','ruins','golem']]},
];
